  ...
  const rows = [
    ...
    },
    {
      ...
      body_html: `
        ...
        <p>Or call me at <a href="tel:+14582988000">458-298-8000</a> or use this consultation link:</p>
        <p><a href="${consultUrl}">Book a free consultation</a></p>
        <p>- Matt</p>
      `,
      source_attribution: sourceAttribution,
      ...
      console.log("Sending assessment notifications via Resend");
        ...
        const clientHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937; line-height: 1.6;">
            ...
            <p>If there is immediate danger, call 911 or local emergency services. For intervention planning or family strategy, call or text me directly at <a href="tel:+14582988000">458-298-8000</a>.</p>
            <p>- Matt Brown<br>Freedom Interventions</p>
          </div>
        `;
