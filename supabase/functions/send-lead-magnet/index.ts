  ...
  const rows = [
    {
      ...
      body_html: `
        ...
        <p>I sent the intervention readiness checklist. If the situation is moving quickly, do not wait on email. Call me directly at <a href="tel:+14582988000">458-298-8000</a>.</p>
    ...
    },
    {
      ...
      body_html: `
        ...
        <p><a href="${consultUrl}">Book a free consultation</a> or call me at <a href="tel:+14582988000">458-298-8000</a>.</p>
        <p>- Matt Brown<br>Freedom Interventions</p>
      `,
      source_attribution: sourceAttribution,
...
<body style="font-family: Georgia, 'Times New Roman', serif; line-height: 1.6; color: #1a365d; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #1a365d; color: white; padding: 25px; border-radius: 8px; text-align: center; margin: 30px 0;">
    ...
    <p style="margin-top: 15px; margin-bottom: 0; font-size: 18px;">📞 (458) 298-8000</p>
  </div>
  ...
  <p style="margin-top: 30px;">
    ...
    <a href="tel:+14582988000" style="color: #1a365d;">(458) 298-8000</a>
  </p>
