...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.family_portal_cases TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.family_portal_members TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.family_portal_updates TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.family_portal_messages TO authenticated;
GRANT ALL ON public.family_portal_cases TO service_role;
GRANT ALL ON public.family_portal_members TO service_role;
GRANT ALL ON public.family_portal_updates TO service_role;
GRANT ALL ON public.family_portal_messages TO service_role;
