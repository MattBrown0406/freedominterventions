...
const LOCATION_META = {
  '/oregon': {
    ...
    description: 'Oregon families facing addiction need expert help now. Matt Brown, certified intervention specialist with 20+ years experience, serves all of Oregon. Free consultation. Call (458) 298-8000.',
  ...
  '/portland-oregon': {
    ...
    description: 'Portland families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Multnomah County. Free consultation. (458) 298-8000.',
  ...
  '/eugene-oregon': {
    ...
    description: 'Eugene families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Lane County. Free consultation. (458) 298-8000.',
  ...
  '/medford-oregon': {
    ...
    description: 'Medford families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Jackson County. Free consultation. (458) 298-8000.',
  ...
  '/hillsboro-oregon': {
    ...
    description: 'Hillsboro families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Washington County. Free consultation. (458) 298-8000.',
  ...
  '/beaverton-oregon': {
    ...
    description: 'Beaverton families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Washington County. Free consultation. (458) 298-8000.',
  ...
  '/gresham-oregon': {
    ...
    description: 'Gresham families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Multnomah County. Free consultation. (458) 298-8000.',
  ...
  '/corvallis-oregon': {
    ...
    description: 'Corvallis families facing addiction get expert intervention support from Matt Brown, certified professional with 20+ years experience. Serving Benton County. Free consultation. (458) 298-8000.',
...
const STATIC_ROUTE_META = {
  '/': {
    ...
    description: 'Matt Brown has 20+ years experience helping families through professional addiction interventions. Free consultation: (458) 298-8000. Nationwide service.',
  ...
  '/contact': {
    ...
    description: 'Schedule a free, confidential consultation with Matt Brown. Professional addiction intervention services available nationwide. Call (458) 298-8000.',
...
<body>
  ...
  <main>
    ...
    <section>
      ...
      <p>Call us now at <a href="tel:+14582988000">(458) 298-8000</a> for a free, confidential consultation. We serve ${safeCity} and all of ${safeState}.</p>
...
function getStaticRouteMeta(pathname) {
  ...
  if (CITY_PAGES[slug]) {
    ...
    return {
      ...
      description: `Need an addiction interventionist in ${city}? Matt Brown provides professional intervention services with 20+ years experience. Call (458) 298-8000.`,
  ...
  if (US_STATES[slug]) {
    ...
    return {
      ...
      description: `Professional drug & alcohol intervention services in ${state}. Over 20 years experience helping families build clear treatment plans. Free consultation: (458) 298-8000.`,
  ...
  if (CANADIAN_PROVINCES[slug]) {
    ...
    return {
      ...
      description: `Professional addiction intervention services in ${province}, Canada. Over 20 years experience helping families. Free consultation: (458) 298-8000.`,
...
<body>
  <main>
    ...
    <section>
      ...
      <p><a href="tel:+14582988000">(458) 298-8000</a></p>
