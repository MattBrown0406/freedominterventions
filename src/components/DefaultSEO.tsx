...
const staticRouteMetadata: Record<string, { title: string; description: string }> = {
  ...
  "/boise-idaho": {
    ...
    description: "Need a drug intervention in Boise? Matt Brown helps Treasure Valley families plan treatment entry, boundaries, and next steps. Call (458) 298-8000.",
  },
  "/oregon": {
  ...
  "/south-dakota": {
    ...
    description: "Need a professional interventionist in South Dakota? Matt Brown helps families plan drug, alcohol, meth, and fentanyl interventions. Call (458) 298-8000.",
  },
  "/iowa": {
    title: "Drug Intervention in Iowa | Professional Interventionist for Families",
    description: "Need a drug intervention in Iowa? Matt Brown helps families plan treatment entry, boundaries, and intervention next steps. Call (458) 298-8000.",
  },
  "/louisiana": {
  ...
  "/fort-worth-texas": {
    ...
    description: "Fort Worth fentanyl intervention and treatment planning help for families. Matt Brown helps move loved ones toward care. Call (458) 298-8000.",
  },
  "/crisis-support": {
...
function getRouteMetadata(pathname: string): { title: string; description: string } | null {
  ...
  if (usStates[slug]) {
    ...
    return {
      ...
      description: `Professional drug & alcohol intervention services in ${stateName}. Over 20 years experience helping families build clear treatment plans. Free consultation: (458) 298-8000.`,
    };
  }
  ...
  if (canadianProvinces[slug]) {
    ...
    return {
      ...
      description: `Professional addiction intervention services in ${provinceName}, Canada. Over 20 years experience helping families. Free consultation: (458) 298-8000.`,
    };
  }
  ...
  if (formatted) {
    return {
      ...
      description: `Professional addiction intervention services. Over 20 years experience helping families. Free consultation: (458) 298-8000.`,
    };
  }
