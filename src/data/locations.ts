...
export const usCities: CityData[] = [
  ...
  { name: "Colorado Springs", state: "Colorado", stateAbbr: "CO", slug: "colorado-springs-colorado" },
  { name: "Aurora", state: "Colorado", stateAbbr: "CO", slug: "aurora-colorado" },
  { name: "Fort Collins", state: "Colorado", stateAbbr: "CO", slug: "fort-collins-colorado" },
  ...
  { name: "Wichita", state: "Kansas", stateAbbr: "KS", slug: "wichita-kansas" },
  { name: "Overland Park", state: "Kansas", stateAbbr: "KS", slug: "overland-park-kansas" },
  { name: "Topeka", state: "Kansas", stateAbbr: "KS", slug: "topeka-kansas" },
  ...
  { name: "San Antonio", state: "Texas", stateAbbr: "TX", slug: "san-antonio-texas" },
  { name: "Fort Worth", state: "Texas", stateAbbr: "TX", slug: "fort-worth-texas" },
  { name: "El Paso", state: "Texas", stateAbbr: "TX", slug: "el-paso-texas" },
  { name: "Plano", state: "Texas", stateAbbr: "TX", slug: "plano-texas" },
  { name: "Albuquerque", state: "New Mexico", stateAbbr: "NM", slug: "albuquerque-new-mexico" },
  { name: "Santa Fe", state: "New Mexico", stateAbbr: "NM", slug: "santa-fe-new-mexico" },
  { name: "Las Cruces", state: "New Mexico", stateAbbr: "NM", slug: "las-cruces-new-mexico" },
