            ...
            <div className="max-w-5xl mx-auto grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <TrackedPhoneLink phoneNumber="+14582988000" metadata={{ location: "sober_helpline_bridge_hero" }}>
          ...
          <div className="container px-6">
            ...
            <div className="grid gap-5 md:grid-cols-2 max-w-6xl mx-auto">
              {paths.map((path) => {
                ...
                if (path.type === "phone") {
                  return (
                    <TrackedPhoneLink key={path.title} phoneNumber="+14582988000" metadata={{ location: path.event }} className="block h-full">
                      {card}
                    </TrackedPhoneLink>
                  );
                }
