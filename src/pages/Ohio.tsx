          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              ...
              <div className="prose prose-lg text-muted-foreground space-y-4">
                ...
                <p>
                  Without professional guidance, family intervention attempts succeed only 20-30% of the time. Well-meaning efforts often devolve into arguments or ultimatums that push the addicted person further away. Professional interventionists provide the structure and expertise that achieves significantly higher treatment acceptance.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">
            Schedule Free Consultation for Your Ohio Family
          </h2>
