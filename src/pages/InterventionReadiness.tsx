            ...
            <div className="max-w-5xl mx-auto grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <TrackedPhoneLink phoneNumber="+14582988000" metadata={{ location: "intervention_readiness_hero" }}>
        ...
        <section className="py-16 md:py-24">
          <div className="container px-6 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <TrackedPhoneLink phoneNumber="+14582988000" metadata={{ location: "intervention_readiness_footer" }}>
