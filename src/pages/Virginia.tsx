...
const Virginia = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Virginia Addiction Intervention Services"
        description="Professional intervention services for Virginia families. Expert interventionists help loved ones find treatment across the Commonwealth."
        canonical="https://freedominterventions.com/virginia"
        keywords="Virginia intervention, addiction help VA, interventionist Richmond, drug intervention Virginia Beach, Norfolk addiction help"
        geoRegion="US-VA"
      ...
      <section className="pt-8 pb-16 bg-gradient-to-b from-primary/10 to-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">Virginia faces opioid challenges. Professional interventionists help families find recovery.</p>
