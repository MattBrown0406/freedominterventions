  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Everything families ask about addiction intervention. How it works, what it costs, what to say, and what happens if they refuse. Free consultation: (458) 298-8000."
